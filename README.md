...
* depends on [Aurora Relayer v2 Common] library which provides common functionality for public and private Aurora Relayer implementations

## How To Build

```bash
git clone https://github.com/aurora-is-near/aurora-relayer-go.git
cd aurora-relayer-go
make
```
...
[Aurora Relayer v2]: https://github.com/aurora-is-near/aurora-relayer-go
[Aurora Relayer v2 Dist]: TODO
[Aurora Relayer v2 Common]: https://github.com/aurora-is-near/aurora-relayer-go-common
[BadgerDB]: https://github.com/dgraph-io/badger#badger-documentation

[Configuration]: https://github.com/aurora-is-near/aurora-relayer-go#configuration
